...
function App() {
  ...
  const updateBoard = (index) => {
    ...
    if(newWinner) {
      ...
      setWinner(newWinner);
      /* 
        * Other way of manage the state. In this way we are going to manage the preview state and the new state in this case the winner
        setWinner((prevWinner) => {
          console.log(`Winner: ${newWinner}, and the laat winner before the new winner wzs ${prevWinner}`);
          return newWinner;  
        });
      */
